...
const Booking: React.FC = () => {
  ...
  const inputClass = "w-full px-4 py-3 rounded-lg border border-slate-400 focus:ring-2 focus:ring-primary-500 focus:border-primary-500 outline-none hover:border-primary-400 transition-colors bg-white text-slate-900 placeholder-slate-500 font-medium shadow-sm";
  ...
  return (
    <div className="bg-slate-50 min-h-screen">
      <section className="bg-primary-900 text-white pt-32 pb-12">
             ...
             <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                   ...
                   <div>
                     ...
                     <input type="tel" name="phone" required value={formData.phone} onChange={handleChange} className={inputClass} placeholder="050..." />
                   </div>
                </div>
                ...
                <div>
                  <label className="block text-sm font-bold text-slate-700 mb-1">Type of Service</label>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <div className="relative">
                       <input type="time" name="time" required value={formData.time} onChange={handleChange} className={inputClass} />
                    </div>
                  </div>
                </div>
